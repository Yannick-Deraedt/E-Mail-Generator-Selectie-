...
export default function App() {
  ...
  function generateEmail() {
    ...
    const carpoolText = matchType === "Uitwedstrijd"
      ? `<div style="margin-top:10px;background:#c6e6fb;padding:10px;border-radius:6px;border:1px solid #2076b9;">
    ...
    const html = `
      <div style="font-family:sans-serif;line-height:1.6;max-width:600px;margin:auto;background:#fff;color:#11294d;border-radius:14px;box-shadow:0 2px 8px #0002;border:2px solid #2076b9;">
        <div style="background:#c6e6fb;border-radius:12px;padding:18px 24px 10px 24px;margin-bottom:20px;">
    ...
    <div className="p-3 md:p-8 min-h-screen" style={{ background: "#11294d" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <div className="rounded-xl" style={{ background: "#eafaf1" }}>
        ...
        <div className="mb-10">
          ...
          <div className="font-semibold mb-1 text-[#11294d]">Zoek en selecteer spelers</div>
          <input
            type="text"
            placeholder="Zoek speler..."
            value={searchSelect}
            ...
            autoComplete="off"
          />
          <div className="rounded-xl" style={{ background: "#fff7f7" }}>
            <table className="min-w-full">
              <thead>
                <tr style={{ background: "#ffd7d7" }}>
        ...
        {/* ACTIEKNOPPEN */}
        <div className="sticky bottom-0 py-4 z-10 flex gap-4 border-t border-[#2076b9]" style={{ background: "#11294d" }}>
          <button
        ...
        {/* PREVIEW */}
        <div className="bg-white text-black p-4 rounded mt-7 shadow" ref={previewRef} style={{ border: '2px solid #2076b9' }}>
