// App.tsx – volledige code met interacties én verbeterde layout in preview
  ...
  const generateEmail = () => {
    ...
    const email = `
      <div style='font-family: Arial, sans-serif; padding: 1rem;'>
        ...
        <p style='margin-bottom: 2rem;'>Aanstaande <strong>${
          day || "[dag]"
        }</strong> spelen we een <strong>${matchType}</strong> tegen <strong>${
      opponent || "[tegenstander]"
    }</strong>. Hieronder vinden jullie alle belangrijke details voor de wedstrijd.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {matchType === "Uitwedstrijd" && (
          <input
            ...
            value={arrivalTimeOpponent}
            onChange={(e) => setArrivalTimeOpponent(e.target.value)}
          />
        )}
        <input
          className="border p-2"
          placeholder="Verzamelplaats"
